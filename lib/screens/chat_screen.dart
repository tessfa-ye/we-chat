                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      ...
                      // form uploading and sending image one by one
                      for (var i in images) {
          ...
          MaterialButton(
            onPressed: () {
              if (_textController.text.isNotEmpty) {
                if (_list.isEmpty) {
                  // on first message(add user to my_users)
            ...
            minWidth: 0,
            padding: EdgeInsets.only(top: 9, bottom: 9, left: 10, right: 5),
            shape: CircleBorder(),
            color: Colors.green,
